...
SYMM_LABELS = ["Binds"]
MAP_LABELS = {"status_of": "status_of"}

# ann = "data/relext_ner_dev.json"
# train_file = "data/relext_ner_dev.spacy"
# dev_file = "path_to/relations_train.spacy"
...
def main(json_loc: Path, train_file: Path):
    ...
    msg.info(f"{len(docs['total'])} training sentences")
